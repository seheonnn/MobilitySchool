...
#define FADE_STEP           PWM_PERIOD / 1000                        /* PWM duty cycle for the TOM                   */
...
void setLED(uint32_t percentage){
    g_fadeValue = percentage * FADE_STEP;
    setDutyCycle(g_fadeValue);
}

void makeSound(unsigned int soundIdx){
    float fBuzz[8] = {261.6f, 293.724f, 329.724f, 349.309f, 392.089f, 440, 493.858f};
    unsigned int uPeriod = (unsigned int)(10000000 / fBuzz[soundIdx]);
    if(soundIdx == 7) uPeriod = 10000000;
    g_tomConfig.period = uPeriod;
    g_tomConfig.dutyCycle = (unsigned int)(uPeriod * 0.05f);
//    if(soundIdx == 7) g_tomConfig.dutyCycle = 0;
