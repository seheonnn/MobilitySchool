OUT 사용 - 여러 bit를 한 번에 제어, 전체 수정, FND 세븐세그먼트

OMR 사용 - 부분 부분 bit 하나 수정

```
// 실습 1 0.5초마다 Interrupt 발생
/**********************************************************************************************************************
 * \file Cpu0_Main.c
...
void STM_Int0Handler(void)
{
    ...
    IfxStm_increaseCompare(g_Stm.stmSfr, g_Stm.stmConfig.comparator, 50000000u); // 50M마다 Interrupt 발생. 0.5초
